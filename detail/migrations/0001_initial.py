# Generated by Django 3.1.7 on 2021-02-20 08:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='detail.category', verbose_name='分类')),
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to=settings.AUTH_USER_MODEL, verbose_name='作者')),
                ('tag', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='detail.tag', verbose_name='标签')),
            ],
            options={
                'verbose_name': '知识',
